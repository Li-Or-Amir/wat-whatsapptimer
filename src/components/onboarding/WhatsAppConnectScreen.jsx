...
const features = [
  {
    ...
    description: "Send WhatsApp messages at the perfect time"
  },
  {
    icon: MessageCircle,
    title: "Never Forget",
    description: "Birthday wishes, reminders, and follow-ups on autopilot"
  },
  {
    icon: Shield,
    title: "Private & Secure",
    description: "Your messages stay between you and your contacts"
  }
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">Schedule WhatsApp messages with ease</p>
        </div>
        ...
        >
          Currently only <span className="font-medium text-slate-500">WhatsApp Business</span> accounts are supported. 
          Personal WhatsApp accounts are not supported at this time.
        </motion.p>
      </motion.div>
    </div>
  );
